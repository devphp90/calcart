...
class TypeController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','delete','GeneratePdf','GenerateExcel'),
				'users'=>array('@'),
			),
	...
	public function actionDelete($id)
	{
		...
		//{
		  ...
		  if($this->loadModel($id)->expense_count==0)
                     {
			...
			throw new CHttpException(400,'The Type you tried to delete is already in use.');
	}
