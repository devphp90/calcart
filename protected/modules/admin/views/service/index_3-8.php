...
$this->widget('bootstrap.widgets.TbMenu', array(
		...
		'items'=>array(
			...
			array('label'=>'Export to PDF', 'icon'=>'icon-download', 'url'=>Yii::app()->controller->createUrl('GeneratePdf'), 'linkOptions'=>array('target'=>'_blank','title'=>'comming soon'), 'visible'=>true,'htmlOptions'=>array('title'=>'123')),
			array('label'=>'Export to Excel', 'icon'=>'icon-download', 'url'=>Yii::app()->controller->createUrl('GenerateExcel'), 'linkOptions'=>array('target'=>'_blank','title'=>'comming soon'), 'visible'=>true),
